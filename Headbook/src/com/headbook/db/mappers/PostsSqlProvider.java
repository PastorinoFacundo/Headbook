...
import com.headbook.db.model.PostsExample.Criteria;
import com.headbook.db.model.PostsExample.Criterion;
...
public class PostsSqlProvider {
    ...
    public String insertSelective(Posts record) {
        ...
        if (record.getDate() != null) {
            VALUES("date", "#{date,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(PostsExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
