...
<%-- 	<%@include file="/resources/views/includes/loading.html"%> --%>
	...
	<%@include file="/resources/views/home/home.html"%>
...
<!-- 	APPS -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/home/app-home.js"></script>
	
<!-- 	CONTROLLERS -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/home/home-controller.js"></script>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/home/postDetailController.js"></script>
